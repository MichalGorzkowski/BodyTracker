...
//  BodyTracker
//
//  Created by mGorzkowski on 30/04/2022.
//
...
class BodySkeleton: Entity {
    ...
    required init(for bodyAnchor: ARBodyAnchor) {
        ...
        for jointName in ARSkeletonDefinition.defaultBody3D.jointNames {
            ...
            // Create an entity for the joint, add to joints directory and add it to the parent entity
        ...
        for bone in Bones.allCases {
            ...
            // Create an entity for the bone, add to bones directory and add it to the parent entity
    ...
    required init() {
        fatalError("init() has not beed implemented")
    }
